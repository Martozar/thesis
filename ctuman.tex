...
%(https://mlyon25.files.wordpress.com/2015/09/methodology-for-manual-traffic-counts.pdf)
...
Tensor cores are capable of performing one matrix-multiply-and accumulate operation in a 4$\times$4 matrix in one GPU clock cycle.%https://arxiv.org/pdf/1803.04014.pdf
...
\begin{figure}[h]
\caption{Deep Learning accelerator architecture %https://devblogs.nvidia.com/nvidia-jetson-agx-xavier-32-teraops-ai-robotics/
}
\label{fig:dla}
...
\begin{figure}[h]
\caption{Vision Accelerator %https://devblogs.nvidia.com/nvidia-jetson-agx-xavier-32-teraops-ai-robotics/
}
\label{fig:va}
